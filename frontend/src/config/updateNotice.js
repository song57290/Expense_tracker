...
//   x.xx → 버그 수정 · 소소한 개선
export const CURRENT_VERSION = 'ver 2.34'
export const UPDATE_DATE = '2026년 7월 20일'

export const UPDATES = [
  {
    section: '📅 날짜 선택 개선',
    items: [
      { tag: 'new', title: '커스텀 날짜 피커 전 탭 통일', desc: '홈·캘린더·수정·예산 탭의 날짜 입력이 기본 날짜 선택창 → 커스텀 달력 팝업으로 교체 — 일관된 디자인으로 통일' },
      { tag: 'new', title: '연도 드럼 스크롤 (1900~2100)', desc: '달력에서 연도▾를 클릭하면 드럼 스크롤로 빠르게 연도 선택 가능 — 기존 10년 단위 그리드 방식 대체' },
      { tag: 'imp', title: '달력 팝업 중앙 배치 + 화살표 위치 개선', desc: '팝업이 화면 중앙에 뜨도록 변경, 이전/다음 월 화살표가 양 끝 → 월 텍스트 바로 옆으로 이동' },
    ],
  },
  {
    section: '📊 통계',
    items: [
      { tag: 'imp', title: '월 클릭하여 바로 이동', desc: '통계 탭 상단 월 표시를 클릭하면 드럼 피커로 원하는 달로 바로 이동 — 화살표로만 이동하던 방식 개선' },
    ],
  },
  {
    section: '📅 캘린더',
    items: [
      { tag: 'new', title: '실적 제외 / 통계 제외 토글 추가', desc: '내역 추가 폼에 카드 실적 제외와 통계 제외 토글 추가 — 홈 탭과 동일하게 캘린더에서도 바로 설정 가능' },
    ],
  },
  {
    section: '⚙️ PC 설정',
    items: [
      { tag: 'new', title: 'PC 알림 시간 드럼 피커', desc: 'PC 사이드바의 알림 시간 설정이 기본 시간 입력창 → 오전/오후·시·분 드럼 피커로 변경 — 모바일과 동일한 방식' },
    ],
  },
  {
    section: '🎨 UI 개선',
    items: [
      { tag: 'imp', title: '카테고리 선택 높이 통일', desc: '금액 입력 칸과 카테고리 선택 버튼의 높이를 동일하게 맞춤 — 폼 레이아웃이 고르게 정렬' },
    ],
  },
]
