...
//   x.xx → 버그 수정 · 소소한 개선
export const CURRENT_VERSION = 'ver 2.40'
...
export const VERSION_HISTORY = [
  {
    ...
    updates: [
      { section: '📅 캘린더 개선', items: [
        { tag: 'new', title: '내역 꾹 누르기 → 수정·삭제', desc: '날짜 클릭 팝업과 월별 목록 모두에서 내역을 꾹 누르면 수정·삭제 바텀시트 표시' },
        { tag: 'new', title: '카드별 필터', desc: '월별 내역 목록 위에 가로 스크롤 칩 행 추가 — 해당 달에 사용한 카드별로 내역 필터링 가능' },
      ]},
      ...
      { section: '🔧 버그 수정 · 개선', items: [
        { tag: 'imp', title: '청약·대출 입력 폼 순서 개선', desc: '날짜 → 금액 → 등록 순서로 자연스럽게 개선' },
        { tag: 'fix', title: '대출 종합 이달 상환 합계 오류 수정', desc: '이달 상환 금액이 지출 합계로 잘못 표시되던 문제 수정' },
      ]},
    ],
  },
  {
